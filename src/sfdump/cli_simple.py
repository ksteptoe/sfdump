...
def setup() -> None:
    ...
    click.echo("=" * 50)
    click.echo()
    click.echo("You need a Connected App configured for Client Credentials flow.")
    click.echo("Ask your Salesforce admin for the Consumer Key and Secret.")
    click.echo()
    ...
    login_url = click.prompt(
        "Salesforce Instance URL (SF_LOGIN_URL)",
        default="https://yourcompany.my.salesforce.com",
        show_default=True,
    )
...
"""
    ...
    click.echo("  sf test    # Verify your connection works")
